...
public interface EmployeeRepository extends JpaRepository<Employee,Long> {
    ...
    @Query(value = "select * from employees e where e.first_name=:fistName and e.last_name =:lastName", nativeQuery = true)
    Employee findByNativeSQLNamed(@Param("fistName") String firstName, @Param("lastName") String lastName);
